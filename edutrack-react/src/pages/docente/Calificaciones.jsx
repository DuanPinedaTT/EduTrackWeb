...
const obtenerEstadoNota = (nota) => {
  if (nota >= 4.5) return { label: "Excelente", variant: "default" }
  if (nota >= 3.5) return { label: "Bueno", variant: "secondary" }
  if (nota >= 3.0) return { label: "Aceptable", variant: "outline" }
  return { label: "Bajo", variant: "destructive" }
}
