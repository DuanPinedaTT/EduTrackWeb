...
export default function PaginaDashboardDocente() {
  const estadisticas = [
    ...
    },
    {
      ...
      valor: "142",
      descripcion: "En todas las materias",
      icono: Users,
    ...
    },
    {
      ...
      valor: "8",
      descripcion: "Estudiantes en riesgo",
      icono: Bell,
      color: "text-red-600",
    },
  ]
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Materias que tienes asignadas este periodo</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <Link href="/docente/notificaciones">
                <Button variant="outline" className="w-full justify-start gap-2 bg-transparent">
