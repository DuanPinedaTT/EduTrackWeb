...
const periodos = [
  { id: 1, nombre: "Primer Periodo 2025", fechaInicio: "2025-01-15", fechaFin: "2025-03-30", estado: "Activo" },
  { id: 2, nombre: "Segundo Periodo 2025", fechaInicio: "2025-04-01", fechaFin: "2025-06-15", estado: "Próximo" },
  { id: 3, nombre: "Tercer Periodo 2025", fechaInicio: "2025-07-01", fechaFin: "2025-09-30", estado: "Próximo" },
  { id: 4, nombre: "Cuarto Periodo 2025", fechaInicio: "2025-10-01", fechaFin: "2025-11-30", estado: "Próximo" },
]
                  ...
                  return (
                    <FilaTabla key={periodo.id}>
                      ...
                      <CeldaTabla className="text-center">
                        <Insignia variant={obtenerVarianteEstado(periodo.estado)}>{periodo.estado}</Insignia>
                      </CeldaTabla>
                      <CeldaTabla>
