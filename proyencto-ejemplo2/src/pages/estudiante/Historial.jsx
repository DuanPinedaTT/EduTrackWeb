...
export default function PaginaHistorialEstudiante() {
  return (
        ...
        <Tarjeta>
          ...
          <ContenidoTarjeta>
            <Tabla>
              ...
              <CuerpoTabla>
                {historialAnual.map((registro) => (
                  <FilaTabla key={registro.ano}>
                    <CeldaTabla className="font-medium">{registro.ano}</CeldaTabla>
                    <CeldaTabla className="text-center text-lg font-bold text-green-600">
                      {registro.promedio.toFixed(1)}
                    </CeldaTabla>
                    <CeldaTabla className="text-center">
                      <Insignia variant={registro.estado === "En Curso" ? "secondary" : "default"}>
                        {registro.estado}
                      </Insignia>
                    </CeldaTabla>
                    <CeldaTabla className="text-center">
