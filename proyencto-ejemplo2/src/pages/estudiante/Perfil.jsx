...
import { Calendar, GraduationCap, Mail, MapPin, Phone, Save, User } from "lucide-react"
  ...
  return (
    <DisenoTablero rolRequerido="estudiante">
      <div className="space-y-6">
            ...
            <ContenidoTarjeta className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Entrada id="telefono" defaultValue="+57 300 987 6543" />
                </div>
                <div className="space-y-2">
                  <Etiqueta htmlFor="documento">Documento</Etiqueta>
                  <Entrada id="documento" defaultValue="1098765432" />
                </div>
                <div className="space-y-2">
                  <Etiqueta htmlFor="direccion">Dirección</Etiqueta>
                  <Entrada id="direccion" defaultValue="Carrera 45 #12-34" />
                </div>
                <div className="space-y-2">
        ...
        <Tarjeta>
          <EncabezadoTarjeta>
            <TituloTarjeta>Información Académica</TituloTarjeta>
            <DescripcionTarjeta>Datos de tu trayectoria educativa</DescripcionTarjeta>
          </EncabezadoTarjeta>
          <ContenidoTarjeta>
            <div className="grid gap-4 md:grid-cols-3">
              <div className="space-y-2">
                <Etiqueta>Grado Actual</Etiqueta>
                <Entrada defaultValue="10° Grado" disabled />
              </div>
              <div className="space-y-2">
                <Etiqueta>Grupo</Etiqueta>
                <Entrada defaultValue="A" disabled />
              </div>
              <div className="space-y-2">
                <Etiqueta>Jornada</Etiqueta>
                <Entrada defaultValue="Mañana" disabled />
              </div>
            </div>
          </ContenidoTarjeta>
        </Tarjeta>
